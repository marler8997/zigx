...
pub const request = struct {
    ...
    // QueryVersion is just an alias to GetVersion so generic code can just always
    // assume this request is the same name for every extension.
    pub const QueryVersion = GetVersion;
    ...
    pub fn GetVersion(
        ...
        try x11.writeInt(sink.writer, &offset, u16, wanted_minor_version);
